...
public class App {
	...
	public void testGet() throws Exception {
		...
		List list=session.createQuery("from cn.itcast.f_extends2.Animal").list();
		System.out.println(list);//[cn.itcast.f_extends2.Dog@64f30e2d, cn.itcast.f_extends2.Cat@7c0d633a]
